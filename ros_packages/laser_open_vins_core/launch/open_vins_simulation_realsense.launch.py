...
def generate_launch_description():
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            'open_vins_params_folder',
            default_value='simulation_realsense',
            description='Name of the folder containing the camera OpenVINS files.'))
    ...
    declared_arguments.append(
        DeclareLaunchArgument(
            'topic_camera0',
            default_value=['/', EnvironmentVariable('uav_name'), '/front_rgbd/infra1/image_raw'],
            description='Name of the camera 0 topic.'))

    declared_arguments.append(
        DeclareLaunchArgument(
            'topic_camera1',
            default_value=['/', EnvironmentVariable('uav_name'), '/front_rgbd/infra2/image_raw'],
