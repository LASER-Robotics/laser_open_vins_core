...
def generate_launch_description():
    ...
    ld.add_action(DeclareLaunchArgument(
        'realsense_config',
        default_value='realsense_vins.yaml',
        description='Name of the Realsense camera configuration file.'
    ))
    ...
    ld.add_action(
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource([
                FindPackageShare('realsense2_camera'), '/launch/rs_camera_container.launch.py'
            ]),
            launch_arguments={
                'use_sim_time': use_sim_time,
